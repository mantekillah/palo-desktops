...
- `Obro Windows PowerShell` (com a administrado, per executar *Windows Toolbox By Chris Titus*)
  - `Copio al PowerShell` `iwr -useb https://git.io/JJ8R4 | iex` (codi de [Chris Titus Tech](https://github.com/ChrisTitusTech/win10script))

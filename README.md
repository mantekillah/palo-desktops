...
- `Instal·lo el software que em falta`:
  - [***Geek Uninstaller***](https://geekuninstaller.com/download), [***mGBA***](https://mgba.io/downloads.html), [***Opera GX***](https://www.opera.com/computer/thanks?ni=eapgx&os=windows), [***Tor***](https://www.torproject.org/ca/download/), [***ONLYOFFICE***](https://www.onlyoffice.com/es/download-desktop.aspx?from=desktop), [***VirtualBox*** + ***Extension Pack***](https://www.virtualbox.org/wiki/Downloads),
